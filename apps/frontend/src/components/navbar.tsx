      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/#menu" className="relative group">
              <span className="text-gray-700 hover:text-orange-600 transition-colors duration-200">菜單介紹</span>
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="https://maps.app.goo.gl/Ao4XE8KkccgKY2Nk7" target="_blank" className="relative group">
              <span className="text-gray-700 hover:text-orange-600 transition-colors duration-200">門市據點</span>
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="/about" className="relative group">
              <span className="text-gray-700 hover:text-orange-600 transition-colors duration-200">關於我們</span>
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="https://www.facebook.com/people/%E6%98%9F%E6%A9%99-%E8%BC%95%E9%A3%9F%E5%92%96%E5%95%A1/100093377431697/" target="_blank" className="relative group">
              <span className="text-gray-700 hover:text-orange-600 transition-colors duration-200">聯絡我們</span>
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </div>
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-96' : 'max-h-0'}`}>
          <div className="flex flex-col space-y-4 pb-6">
            <Link href="/#menu" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600 transition-colors duration-200">
              菜單介紹
            </Link>
            <Link href="https://maps.app.goo.gl/Ao4XE8KkccgKY2Nk7" target="_blank" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600 transition-colors duration-200">
              門市據點
            </Link>
            <Link href="/about" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600 transition-colors duration-200">
              關於我們
            </Link>
            <Link href="https://www.facebook.com/people/%E6%98%9F%E6%A9%99-%E8%BC%95%E9%A3%9F%E5%92%96%E5%95%A1/100093377431697/" target="_blank" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600 transition-colors duration-200">
              聯絡我們
            </Link>
          </div>
        </div>
